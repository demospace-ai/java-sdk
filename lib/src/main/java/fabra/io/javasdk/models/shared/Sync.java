...
public class Sync {
    ...
    @JsonProperty("cursor_field")public String cursorField;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("custom_join")public String customJoin;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("destination_id")public Long destinationId;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("field_mappings")public FieldMapping[] fieldMappings;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("frequency_units")public FrequencyUnitsEnum frequencyUnits;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("object_id")public Long objectId;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("source_id")public Long sourceId;
