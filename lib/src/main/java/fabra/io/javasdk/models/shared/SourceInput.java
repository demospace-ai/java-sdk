...
public class SourceInput {
    ...
    @JsonProperty("bigquery_config")public BigQueryConfig bigqueryConfig;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("mongodb_config")public MongoDbConfig mongodbConfig;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("redshift_config")public RedshiftConfig redshiftConfig;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("snowflake_config")public SnowflakeConfig snowflakeConfig;
